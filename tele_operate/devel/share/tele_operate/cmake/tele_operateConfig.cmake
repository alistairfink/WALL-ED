...
if("TRUE" STREQUAL "TRUE")
  set(tele_operate_SOURCE_PREFIX /home/alistairfink/temp/temp2/WALL-ED/tele_operate/src/tele_operate)
  set(tele_operate_DEVEL_PREFIX /home/alistairfink/temp/temp2/WALL-ED/tele_operate/devel)
  ...
  set(tele_operate_INSTALL_PREFIX /home/alistairfink/temp/temp2/WALL-ED/tele_operate/install)
...
if(NOT "/home/alistairfink/temp/temp2/WALL-ED/tele_operate/devel/include " STREQUAL " ")
  set(tele_operate_INCLUDE_DIRS "")
  set(_include_dirs "/home/alistairfink/temp/temp2/WALL-ED/tele_operate/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tele_operate' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alistairfink/temp/temp2/WALL-ED/tele_operate/src/tele_operate/${idir}'.  ${_report}")
    endif()
    _list_append_unique(tele_operate_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "tele_operate;motor_driver_lib")
...
set(depends "roscpp;rospy;std_msgs;serial;motor_driver;message_runtime")
