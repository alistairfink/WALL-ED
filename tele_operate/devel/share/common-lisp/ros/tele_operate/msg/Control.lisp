...
(cl:in-package tele_operate-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Control>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Control)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tele_operate-msg:<Control> is deprecated: use tele_operate-msg:Control instead.")))

(cl:ensure-generic-function 'control-val :lambda-list '(m))
(cl:defmethod control-val ((m <Control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tele_operate-msg:control-val is deprecated.  Use tele_operate-msg:control instead.")
  (control m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Control>)))
  ...
  (cl:format cl:nil "int64 control~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Control)))
  "Returns full string definition for message of type 'Control"
  (cl:format cl:nil "int64 control~%~%~%"))
